...
MODEL_NAME_OR_PATH="/homes/gws/lxh22/rl-sft/one-shot-em/checkpoints/Qwen2.5-Math-7B/one_shot/step_10"
OUTPUT_DIR="/homes/gws/lxh22/rl-sft/one-shot-em/checkpoints/Qwen2.5-Math-7B/one_shot/step_10/temp01/eval"
